...
<html lang="en">
  ...
  <link rel="stylesheet" href="./Restro/Resturant Management System/assets/css/style.css">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      <h1>
        <a href="#" class="logo"><img src = "RMS.png" alt="Logo" height="90" width="100">Hantakali<span class="span">.</span></a>
      </h1>
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="nav-item">
            <a href="#contactuss" class="navbar-link" data-nav-link>Contact Us</a>
          </li>
      ...
      <div class="header-btn-group">
        ...
        <button class="btn btn-hover" data-btn btn-hover><a href="#bottom">Reservation </a></button>
  ...
  <main>
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./Restro/Resturant Management System/assets/images/veg.png')">
        <div class="container">

          <div class="hero-content">

            <p class="hero-subtitle">Craving for something ? . . . </p>
            <!-- Super delicious Hantakali Restro in Nepal ! -->

            <h2 class="h1 hero-title">Burgers &#127828 ! Because no great story started with salads &#129367 </h2>

            <!-- Burgers 🍔 ! Because no great story started with salads 🥗 -->
            <p class="hero-text">Life is short, make it happy &#128522 & sweet 	&#129303</p>
            
            <!-- Life is short, make it happy  🤗  &  sweet  😋 -->
            <button class="btn btn-hover"><a href="./Restro/admin/dashboard.php">Dashboard</a></button>

          </div>

          <figure class="hero-banner">
            <img src="./Restro/Resturant Management System/assets/images/hero-banner-bg.png" width="820" height="716" alt="" aria-hidden="true"
              class="w-100 hero-img-bg">

            <img src="./Restro/Resturant Management System/assets/images/result.png" width="200" height="637" loading="lazy" alt="Burger"
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Peppy Paneer Pizza</h3>

                <p class="card-text">
                  A slice of heaven in every oven
                </p>

                <img src="./Restro/Resturant Management System/assets/images/piza.png" width="300" height="350" loading="lazy" alt="Maxican Pizza"
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="./Restro/Resturant Management System/assets/images/coke.png" width="200" height="350" loading="lazy" alt="Soft Drinks"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <p class="card-text">
                  Always share my fries with you
                </p>

                <img src="./Restro/Resturant Management System/assets/images/french.png" width="300" height="350" loading="lazy" alt="French Fry"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Burger King</h3>

                <p class="card-text">
                  One hand is not enough
                </p>

                <img src="./Restro/Resturant Management System/assets/images/bugking.png" width="300" height="350" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Chicken Tikka</h3>

                <p class="card-text">
                  Tantalizing taste of tikka!
                </p>

                <img src="./Restro/Resturant Management System/assets/images/tikka.png" width="300" height="350" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
          ...
          <div class="about-banner">
            <img src="./Restro/Resturant Management System/assets/images/bugwithcoke.png" width="509" height="459" loading="lazy" alt="Burger with Drinks"
              class="w-100 about-img">

            <img src="./Restro/Resturant Management System/assets/images/sale-shape-red.png" width="216" height="226" alt="get up to 50% off now"
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Burgers, Cokes, Fries and Best Pizzas
              <span class="span">in Nepal !</span>
            </h2>

            <p class="section-text">
              This crazy restaurant has left the best impressions! Hospitable hosts, delicious dishes,
               beautiful presentation, wide wine list and wonderful dessert. Customers recommend to everyone! 
               People would like to come back here again and again.
            </p>
            ...
            <button class="btn btn-hover"> <a href="./Restro/admin/products.php">Change</a></button>
          ...
          <ul class="food-menu-list">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/food-menu-3.png" width="300" height="300" loading="lazy"
                    alt="Fried Chicken Unlimited" class="w-100">

                  <div class="badge">-15%</div>

                  <button class="btn food-menu-btn"><a href="./Restro/admin/products.php">Change</a></button>
                </div>
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price">Rs 499.00</data>

                  <del class="del" value="69.00">Rs 699.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/woobug.png" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="29.00">Rs 299.00</data>

                  <del class="del">Rs 399.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/whitecas.png" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="49.00">Rs 499.00</data>

                  <del class="del">Rs 699.00</del>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/buff.png" width="300" height="300" loading="lazy"
                ...
                <div class="price-wrapper">
                  ...
                  <data class="price" value="59.00 ">Rs 599.00</data>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/BBQ.png" width="300" height="300" loading="lazy"
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/choup.png" width="300" height="300" loading="lazy"
                ...
                <h3 class="h3 card-title">Tteok-bokki Ramen</h3>
      ...
      <section class="section section-divider white cta" style="background-image: url('./Restro/Resturant Management System/assets/images/veg.png')">
        <div class="container">

          <div class="cta-content">

            <h2 class="h2 section-title">
              The Hantakali Have Excellent Of
              <span class="span">Quality Restro !</span>
            </h2>

            <p class="section-text">
              During the 19th century, the restaurants in Kathmandu were largely established and operated by foreigner 
              who brought their culinary traditions and skills with them.
              for example, opened pizzerias and pasta houses, while German immigrants introduced beer gardens and sausage shops. 
              Over time, these ethnic cuisines became assimilated into American culture 
              and are now widely enjoyed across the country.
            </p>

            <button class="btn btn-hover"><a href="./Restro/admin/dashboard.php">Order Now</a></button>
          </div>

          <figure class="cta-banner">
            <img src="./Restro/Resturant Management System/assets/images/cta-banner.png" width="700" height="637" loading="lazy" alt="Burger"
              class="w-100 cta-img">
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <div class="delivery-content">
            ...
            <p class="section-text">
              Our restaurant offers fast and reliable delivery services with the latest technology 
              and transportation to ensure fresh and hot food. We make the ordering and delivery process 
              seamless and believe we offer the best delivery experience in town. Try us out today!
            </p>
          ...
          <figure class="delivery-banner">
            <img src="./Restro/Resturant Management System/assets/images/delivery-banner-bg.png" width="700" height="602" loading="lazy" alt="clouds"
              class="w-100">

            <img src="./Restro/Resturant Management System/assets/images/download.png" width="950" height="600" loading="lazy" alt="delivery boy"
      ...
      <section class="section section-divider white testi">
        <div class="container">
          ...
          <p class="section-text">
            "Your satisfaction is our top priority - share your experience and 
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./Restro/Resturant Management System/assets/images/chef.jpg" width="80" height="80" loading="lazy" alt="Charles Richard">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">Gordon James Ramsay</h3>

                    <p class="testi-title">British Chef</p>
                  </div>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./Restro/Resturant Management System/assets/images/raju.jpg" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">Raju Bikram Shah</h3>

                    <p class="testi-title">CEO Hotel Annapurna</p>
                  </div>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./Restro/Resturant Management System/assets/images/thakuri.jpg" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">Rajesh Tuladhar</h3>

                    <p class="testi-title">CEO Hotel Himal</p>
                  </div>

                </div>

                <blockquote class="testi-text">
                  "The staff was friendly and attentive, and the food was simply outstanding. A must-try!"
                </blockquote>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./Restro/Resturant Management System/assets/images/Agrawal.jpg" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">Gaurav Agarwal</h3>

                    <p class="testi-title">MD Marriott Hotel</p>
                  </div>

                </div>

                <blockquote class="testi-text">
                  "I had a wonderful experience at this restaurant - the flavors were unique and delicious."
                </blockquote>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="./Restro/Resturant Management System/assets/images/hayatt.jpg" width="80" height="80" loading="lazy" alt="Thomas Josef">
                  </figure>

                  <div>
                    <h3 class="h4 testi-name">Shakti Golyan</h3>

                    <p class="testi-title">Chairman Hayatt Palace</p>
                  </div>

                </div>

                <blockquote class="testi-text">
                  "The quality of the food and service exceeded my expectations. I can't wait to come back!"
                </blockquote>
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="./Restro/Resturant Management System/assets/images/ramm.jpg" width="550" height="450" loading="lazy"
                  alt="Discount For Delicious Tasty Burgers!" class="banner-img">

                <div class="banner-item-content">
                  <p class="banner-subtitle">50% Off Now!</p>

                  <h3 class="banner-title">Discount For Delicious Tasty Ramen!</h3>

                  <p class="banner-text">Sale off 50% only this week</p>

                  <button class="btn"><a href="./Restro/admin/products.php">Change</a></button>
                </div>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./Restro/Resturant Management System/assets/images/bell.png" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Delicious Burrito</h3>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="./Restro/Resturant Management System/assets/images/combo.jpg" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">

                <div class="banner-item-content">
                  <h3 class="banner-title">Burgers Combo Pack</h3>
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="./Restro/Resturant Management System/assets/images/buzzpizza.jpg" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
          ...
          <ul class="blog-list">
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/blog-1.jpg" width="600" height="300" loading="lazy"
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <time class="meta-info" datetime="2022-01-01">Jan 01 2023</time>
                    </a>

                    <a href="#" class="card-meta-link">
                      <ion-icon name="person-outline"></ion-icon>

                      <p class="meta-info">Rahul Jung Kunwar</p>
                    </a>
    ...
    <div class="card-content">
      ...
      <div class="card-meta-wrapper">
        ...
        <a href="#" class="card-meta-link">
          ...
          <p class="meta-info">Thaman Rai</p>
        </a>
    ...
    <div class="card-content">
      ...
      <div class="card-meta-wrapper">
        ...
        <a href="#" class="card-meta-link">
          ...
          <p class="meta-info">Darshan Shrestha</p>
        </a>
...
<!--  -->
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/blog-2.jpg" width="600" height="300" loading="lazy"
            ...
            <li>
              <div class="blog-card">
                ...
                <div class="card-banner">
                  <img src="./Restro/Resturant Management System/assets/images/blog-3.jpg" width="600" height="300" loading="lazy"
  ...
  <footer class="footer" data-footer>
    ...
    <div  class="footer-top" style="background-image: url('./Restro/Resturant Management System/assets/images/footer-illustration-1.png')">
      <div id="bottom" class="container">

        <div  class="footer-brand">

          <a href="" class="logo">Hantakali<span class="span">.</span></a>

          <p id ="contactuss" class="footer-text">
            Financial experts support or help you to to find out which way you can raise your funds more.
          </p>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">(+977) 9861761876</p>
          </li>

          <li>
            <p class="footer-list-item">Restrohantakali@gmail.com</p>
          </li>

          <li>
            <address class="footer-list-item">Maitidevi, Naxal, Kathmandu</address>
          </li>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Sunday-Friday: 06:00 AM - 12:00 PM</p>
          </li>
          ...
          <li>
            <p class="footer-list-item">Saturday: 10:00 AM - 12:00 PM</p>
          </li>
        ...
        <form  method="POST" class="footer-form">
          ...
          <div class="input-wrapper">
            ...
            <input type="text" name="full_name" required placeholder="Your Name" aria-label="Your Name"
              ...
              class="input-field">
              <select name="table_type" aria-label="Table type" class="input-field">
              <option value="Not Selected">Select table type</option>
                <option value="Rooftop_table">Roof-top Table</option>
                <option value="VIP_table">VIP Table</option>
                <option value="Standard_table">Standard Table</option>
                <option value="Coffee_table">Coffee Table</option>
                <option value="Dining_table">Dining Table</option>
                <option value="Conference_table">Conference Table</option>
          ...
          <div class="input-wrapper">
            ...
            <input type="time" name="time_" required placeholder="Time" aria-label="Time"
            class="input-field">
          ...
          <button name ="btn" type="submit" class="btn">Book a Table</button>
...
if(isset($_POST['btn'])) {
    ...
    $typ = $_POST['table_type'];
    $peop = $_POST['total_person'];
    $bdate = $_POST['booking_date'];
    $tim = $_POST['time_'];
    $mess = $_POST['message'];

    // Prepare the query
    $query = "INSERT INTO `reserve`(`full_name`, `Ph_number`, `Table_type`, `Total_person`, `Booking_date`, `Booking_time`, `Messages`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($conn, $query);

    // Bind the parameters with types
    mysqli_stmt_bind_param($stmt, "sssssss", $fname, $num, $typ, $peop, $bdate, $tim, $mess);
...
?>
    ...
    <div class="footer-bottom">
      <div class="container">
        <!-- <p class="copyright-text">
          &copy; 2023 <a href="#" class="copyright-link">Hantakali Restro</a> All Rights Reserved.
        </p> -->
      </div>
    </div>
  ...
  <!-- 
    - custom js link
  -->
  <script src="./Restro/Resturant Management System/assets/js/script.js" defer></script>
